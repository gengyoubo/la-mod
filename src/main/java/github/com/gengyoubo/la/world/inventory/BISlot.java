...
public class BISlot extends Slot {
    ...
    public BISlot(Container p_40223_, int p_40224_, int p_40225_, int p_40226_) {
    ...
    public boolean isSameInventory(BISlot other) {
        return this.container == other.container;
    }

    public BISlot setBackground(ResourceLocation atlas, ResourceLocation sprite) {
