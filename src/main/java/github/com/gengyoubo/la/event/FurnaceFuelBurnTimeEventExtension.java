package github.com.gengyoubo.la.event;
...
/**
 * {@link FurnaceFuelBurnTimeEventExtension} is fired when determining the fuel value for an ItemStack. <br>
 * <br>
 ...
 **/
@Cancelable
public class FurnaceFuelBurnTimeEventExtension extends Event
{
    @Nonnull
    ...
    public FurnaceFuelBurnTimeEventExtension(@Nonnull ItemStack itemStack, long burnTime, @Nullable RecipeType<?> recipeType)
    {
