...
public class BIFurnaceFuelSlot extends BISlot{
    private final BIAbstractFurnaceMenu menu;

    public BIFurnaceFuelSlot(BIAbstractFurnaceMenu p_39520_, Container p_39521_, int p_39522_, int p_39523_, int p_39524_) {
